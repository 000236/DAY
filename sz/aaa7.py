...
# 将修改后的Word文件保存到本地
try:
    doc.save("sz/2023年第六期大数据师资研修班_new.docx")
except:
    pass
time.sleep(1)
# 将Word文档转换为PDF
...
word_file = "sz/2023年第六期大数据师资研修班_new.docx"
pdf_file = "sz/2023年第六期大数据师资研修班_new1.pdf"
convert_to_pdf(word_file, pdf_file)
time.sleep(5)
# 下载重命名后的PDF文件
# if t2 is not None:

with open("sz/2023年第六期大数据师资研修班_new1.pdf", "rb") as file:
    file_content = file.read()
    st.download_button("点击下载pdf", data=file_content, file_name="sz/2023年第六期大数据师资研修班_new1.pdf")
